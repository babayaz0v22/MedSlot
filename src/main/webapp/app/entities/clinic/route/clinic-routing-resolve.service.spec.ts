...
describe('Clinic routing resolve service', () => {
  ...
  let resultClinic: IClinic | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IClinic returned by find', () => {
      // GIVEN
    ...
    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IClinic>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
