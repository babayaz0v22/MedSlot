...
import { sampleWithRequiredData } from '../doctor-schedule.test-samples';
...
describe('DoctorSchedule Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.doctorSchedules()[0]).toEqual(expect.objectContaining({ id: 17031 }));
  });

  describe('trackId', () => {
    it('should forward to doctorScheduleService', () => {
      const entity = { id: 17031 };
      jest.spyOn(service, 'getDoctorScheduleIdentifier');
      const id = comp.trackId(entity);
      expect(service.getDoctorScheduleIdentifier).toHaveBeenCalledWith(entity);
