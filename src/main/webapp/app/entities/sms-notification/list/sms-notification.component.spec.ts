...
import { sampleWithRequiredData } from '../sms-notification.test-samples';
...
describe('SmsNotification Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.smsNotifications()[0]).toEqual(expect.objectContaining({ id: 23662 }));
  });

  describe('trackId', () => {
    it('should forward to smsNotificationService', () => {
      const entity = { id: 23662 };
      jest.spyOn(service, 'getSmsNotificationIdentifier');
      const id = comp.trackId(entity);
      expect(service.getSmsNotificationIdentifier).toHaveBeenCalledWith(entity);
